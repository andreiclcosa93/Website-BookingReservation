...
<div class="row">
    ...
    <div class="col-md-4">
        <div class="card">
            <form action={{ route('admin.facilities.update',$facility->id) }} id="facility-update-{{ $facility->id }}" method="POST">
                @csrf
                @method('put')
           ...
           {{ $facility->name }}
            ...
            <ul class="list-group list-group-flush">
              <li class="list-group-item"><b>Facilitate:</b>
                <input name="name" type="text" class="form-control" value="{{ old('name',$facility->name) }}">
            </li>
              <li class="list-group-item"><b>Order:</b>
                <input name="order" type="number" class="form-control" value="{{ old('order',$facility->order) }}">
            </li>
              <li class="list-group-item"><b>Descriere:</b>
                <input name="description" type="text" class="form-control" value="{{ old('description',$facility->description) }}">
            </li>
